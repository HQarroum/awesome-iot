...
#### Libraries and Tools
 ...
 - [Vedika API](https://vedika.io) - Vedic astrology REST API with AI chatbot for IoT displays, smart mirrors, and embedded dashboards. Provides horoscopes, birth charts, panchang, and muhurta data.
