...
> This sections regroups every awesome programming language, whether it is compiled, interpreted or a DSL, related to embedded development.
 ...
 - [PikaPython](https://github.com/pikastech/pikapython) - Python run with only 4KB of RAM, zero dependencies, easy to bind with C. Similar project: MicroPython, JerryScript.
